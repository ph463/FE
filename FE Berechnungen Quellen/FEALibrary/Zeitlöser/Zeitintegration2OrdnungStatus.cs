...
namespace FEALibrary.Zeitlöser
{
    public class Zeitintegration2OrdnungStatus
    {
        ...
        public Zeitintegration2OrdnungStatus(Gleichungen systemEquations, double[] damping,
            double dt, int method, double parameter1, double parameter2, double[][] displ, double[][] veloc, double[][] anregung)
        {
        ...
        public Zeitintegration2OrdnungStatus(double[] mass, double[] damping, double[][] stiffness,
        ...
        public void Perform()
        {
            ...
            if (method == 1) { alfa = 0; theta = 1; beta = parameter1; gamma = parameter2; }
            else if (method == 2) { beta = 1.0 / 6; gamma = 0.5; alfa = 0; theta = parameter1; }
            else if (method == 3) { theta = 1; alfa = parameter1; gamma = 0.5 - alfa; beta = 0.25 * (1 - alfa) * (1 - alfa); }
            else throw new BerechnungAusnahme("TimeIntegration2NdOrderStatus: invalid method identifier entered");
