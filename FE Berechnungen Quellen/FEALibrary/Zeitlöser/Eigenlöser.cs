...
namespace FEALibrary.Zeitlöser
{
    public class Eigenlöser
    {
        ...
        //... get() .............................................................
        public double GetEigenValue(int index) { return eigenValue[index]; }
        public double[] GetEigenVector(int index) { return x[index]; }
            ...
            for (state = 0; state < numberOfStates; state++)
            {
                ...
                do
                {
                    ...
                    for (var i = 0; i < state; i++)
                    {
                        ...
                        for (row = 0; row < dimension; row++)
                            if (!status[row]) c += w[row] * x[i][row];
                        for (row = 0; row < dimension; row++)
                            if (!status[row]) w[row] -= c * p[i][row];
                    }
