...
namespace FEALibrary.Model
{
    public class Analysis
    {
        ...
        private void StatusNodes(AbstractBoundaryCondition randbedingung)
        {
            ...
            {
                throw new AnalysisException("Eandknoten " + nodeId + " ist nicht im Modell enthalten.");
            }
        }
        ...
        public void ComputeSystemVector()
        {
            ...
            foreach (var item in modell.Lasten)
            {
                ...
                {
                    throw new AnalysisException("Lastknoten " + nodeId + " ist nicht im Modell enthalten.");
                }
            }
            // Linienenlasten
            foreach (var item in modell.LinienLasten)
            {
                ...
                {
                    throw new AnalysisException("Linienlastknoten " + startNodeId + " ist nicht im Modell enthalten.");
                }
                ...
                {
                    throw new AnalysisException("Linienlastknoten " + endNodeId + " ist nicht im Modell enthalten.");
                }
            ...
            foreach (var item in modell.ElementLasten)
            {
                ...
                {
                    throw new AnalysisException("Element " + elementId + " für Elementlast ist nicht im Modell enthalten.");
                }
            }
            foreach (var item in modell.PunktLasten)
            {
                ...
                {
                    throw new AnalysisException("Element " + elementId + " für Linienlasten ist nicht im Modell enthalten.");
                }
            }
        }
        ...
        public void TimeIntegration1StOrder()
        {
            ...
            if (dt == 0)
            {
                throw new AnalysisException("Abbruch: Zeitschrittintervall nicht definiert.");
            }
        ...
        private void Set1StOrderInitialConditions(IList<double[]> temperature)
        {
            ...
            foreach (NodalValues anf in modell.Zeitintegration.Anfangsbedingungen)
            {
                if (anf.NodeId == "alle")
                {
        ...
        private void Compute1StOrderForcingFunction(double dt, double[][] temperature)
        {
            ...
            foreach (var item in modell.ZeitabhängigeKnotenLasten)
            {
                ...
                {
                    throw new AnalysisException("Knoten " + item.Value.NodeId + " für zeitabhängige Knotenlast ist nicht im Modell enthalten.");
                }
            }
        ...
        private void Compute1StOrderBoundaryConditions(double dt, double[][] temperature)
        {
            ...
            foreach (var item in modell.ZeitabhängigeRandbedingung)
            {
                ...
                {
                    throw new AnalysisException("Knoten " + item.Value.NodeId + " für zeitabhängige Randbedingung ist nicht im Modell enthalten.");
                }
            }
        }
        ...
        public void TimeIntegration2NdOrder()
        {
            ...
            if (dt == 0)
            {
                throw new AnalysisException("Zeitschrittintervall nicht definiert");
            }
            var tmax = modell.Zeitintegration.Tmax;
            var nSteps = (int)(tmax / dt) + 1;
        ...
        private double[] ComputeDampingMatrix()
        {
            ...
            foreach (NodalValues dämpfung in modell.Zeitintegration.DämpfungsRaten)
            {
                ...
                else
                {
                    ...
                    {
                        throw new AnalysisException("Dämpfungsknoten " + dampedNodeId + " ist nicht im Modell enthalten.");
                    }
                }
            }
            return damping;
